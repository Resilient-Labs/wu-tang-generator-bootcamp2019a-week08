...
console.log(sum)
if(sum === 23){
  document.getElementById("hi").innerText = "Bob with dog allergies"
}else if(sum === 24){
  document.getElementById("hi").innerText = "Smoldering heart"
}else if(sum === 25){
  document.getElementById("hi").innerText = "Puppy Hater"
}else if(sum === 26){
  document.getElementById("hi").innerText = "Permiscous passion"
}else if(sum === 27){
  document.getElementById("hi").innerText = "Belligerent babe"
}else if(sum === 28){
  document.getElementById("hi").innerText = "Lovefilled warrior"
}else if(sum === 29){
  document.getElementById("hi").innerText = "Fighting Heart"
}else{
  document.getElementById("hi").innerText = "Mike"
}
})
