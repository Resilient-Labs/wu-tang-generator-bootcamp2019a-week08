...
//
// trek taught me how to make the code more abstract

// let ids = ["red", "blue", "dogs", "platypus", "cheese", "chicken", "young", "old", "hipHop", "reggaeton"]
// let selections = ["selectionOne", "selectionTwo", "selectionThree", "selectionFour", "selectionFive", "selectionSix", "selectionSeven", "selectionEight", "selectionNine", "selectionTen"]
//
// for (let i = 0 ; i < ids.length ; i++) {
//   document.getElementById(ids[i]).addEventListener('click', function () {
//     selections[i] = parseInt(document.getElementById(ids[i]).value);
//   })
// }
